...
│   │   │   ├── Monitor/
│   │   │   ├── Notification/   # 通知运行概览、模板管理等通知运维页面
...
│   ├── Monitor/             # 服务监控、缓存监控
│   ├── Notification/        # 通知运行概览、模板管理
│   ├── Placeholder/         # 应用健康、Request/Task/Delivery、调度、安全等预定义占位页
│   ├── Scheduler/           # 定时任务
