...
- [[35-OA模块]] — 办公自动化模块（9个子模块）
- [[40-文件上传]] — 分片上传/本地存储/S3
- [[45-工作流模块]] — Flowable 流程引擎集成
- [[50-AI模块]] — LangChain4j + RAG 检索增强生成
- [[60-基础设施]] — Redis/PostgreSQL/MyBatis-Plus/Cache/Security
- [[55-接口加解密方案]] — RSA+AES-GCM 前后端接口数据加密
...
- [[30-计划/logicflow-flowable/P-子流程标准化修复计划]] — 子流程标准化修复
