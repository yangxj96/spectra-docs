...
- `core/security/authentication`：认证身份、密码凭证、登录 Provider 和认证身份绑定；内部统一按 `controller`、`javabean`、`mapper`、`service`、`service/impl`、`util` 组织。
