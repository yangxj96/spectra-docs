...
- [x] 已在浏览器中完成消息铃铛、抽屉、详情、筛选、已读、删除和偏好交互验收。
...
- [x] NotificationBell组件正确显示铃铛图标和未读数
- [x] 点击铃铛正确打开右侧抽屉
- [x] 抽屉中消息列表正确显示
- [x] Tab切换正确筛选消息类型
- [x] 点击消息正确标记已读并跳转
- [x] "全部已读"按钮正确工作
- [x] "查看全部消息"正确跳转到消息中心页面
...
- [x] 启动开发服务器（Vite 开发服务器）
- [x] 使用真实账号登录系统，检查头部铃铛显示和 Bearer Token 请求
- [x] 点击铃铛，检查抽屉、已读和跳转功能
- [x] 导航到消息中心页面，检查筛选、批量删除和详情功能
- [x] 查询和保存用途×渠道偏好，确认强制安全用途仍不可关闭
