...
**P0 阶段 0、阶段 1 和阶段 2 已完成首版；阶段 3（报销、采购、资产、办公用品与部门统计首版纵切）进行中，其余阶段待启动**
...
> 当前进度：文档目录、文档元数据、文件版本链、草稿/发布和受鉴权预览下载首版已完成；合同台账、文件版本、签署/生效/终止状态和履约节点首版已完成。ACL 明细授权、审批、通知、到期提醒和检索归档待后续迭代。
...
| P1 | 阶段 3：行政与费用 | 进行中：报销、采购、资产、办公用品库存和部门统计导出首版已完成，财务增强待实施 | 阶段 1，可与阶段 2 后半并行 |
| P1-P2 | 阶段 4：文档与合同 | 进行中：文档和合同台账首版已完成，权限/审批/提醒/检索待增强 | Upload、Notification 完整可用 |
